...
Feed.prototype.toArray = function() {
  throw new Errors.ThinkyError("The `toArray` method is not available on feeds.");
}
...
Feed.prototype._makeEmitter = function() {
  this.next = function() {
    throw Errors.ThinkyError("You cannot called `next` once you have bound listeners on the feed")
  }
  this.each = function() {
    throw Errors.ThinkyError("You cannot called `each` once you have bound listeners on the feed")
  }
  this.toArray = function() {
    throw Errors.ThinkyError("You cannot called `toArray` once you have bound listeners on the feed")
  }
